        ...
        <div className="header">
            <div className="header__conteiner">
                ...
                <div className="header__basket">
                    <div className="header__basket__content">
                        <div className="header__basket__price">
                            {Math.round(total)} ₽
                        </div>
                        <div className="header__basket__qt">
                            <div className="header__basket__qt__icon">
                            ...
                            <div className="header__basket__qt__sum">
                                {basket.length}
                            </div>
                        </div>
                    </div>
